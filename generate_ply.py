...
def main():
    ...
    imgpath = 'C:\\Users\\NaJaM\\Downloads\\folder\\3DSfMFaceReconstruction-master\\FaceReconstruction\\test_image\\18_eye_closed_0009_090.png'
    disppath = 'C:\\Users\\NaJaM\\Downloads\\folder\\3DSfMFaceReconstruction-master\\FaceReconstruction\\output\\-18_eye_closed_0009_090_disp.png'
    
    # Print the paths to ensure they are correct
    print(f'Image path: {imgpath}')
    print(f'Disparity path: {disppath}')
    
    imgL = cv.imread(imgpath)
    
    # Check if the image is loaded correctly
    if imgL is None:
        print('Error: Unable to load image at path:', imgpath)
        return
    ...
    # Check if the disparity image is loaded correctly
    if disp is None:
        print('Error: Unable to load disparity image at path:', disppath)
        return
